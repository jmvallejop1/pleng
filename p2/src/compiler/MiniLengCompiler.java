...
//    System.out.println("1");
    ...
    case tID:
      id = jj_consume_token(tID);
                ...
                if(simbolo_id.ES_VARIABLE()) {
                        if(simbolo_id == null) {
                        System.out.println("Error semantico, no existe el simbolo con nombre: " + id.image +" en la tabla de simbolos. En la linea " + id.beginLine + " y la columna " + id.beginColumn);
  ...
  boolean accesoComponente = false;
    ...
    if(id.ES_ACCION()){
        //TODO: excepciones
        System.out.println("Error semantico: No se puede asignar una expresion a una accion. En la linea " + id.beginLine + " y la columna " + id.beginColumn);
...
>>>>>>> 9bc35d1c3c484e9921b43863e7aa2f3a5066f888
